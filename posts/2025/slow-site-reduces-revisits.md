...
そのファンづくりの最初のステップが「再訪問」です。サイトにもう一度来てもらえなければ、リピート購入につながらず、ファン化もできません。
...
なお、このグラフで採用しているのは「最小LCP」、つまりサイト訪問を通じてもっとも速かったLCPの値です。最小LCPが悪いということは、そのユーザーは一度も快適な表示体験ができなかったことを意味します。逆に言えば、少なくとも一度は快適な体験ができたユーザーは、55%という高い再訪問率を示しています。
...
**すべてのサイトで同じ傾向が確認されました。LCPが悪くなるほど、再訪問率も下がる──そのような関係性が見えてきます。** サイトの規模や扱う商品ジャンルに関わらず、この法則は普遍的に成り立っています。
