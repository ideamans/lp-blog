...
date: 2025-12-09
image: ./next-gen-image-format.jpg
categories:
 - image-fitness
---
...
よほど小規模なサイトでない限り、画像の変換や非対応ブラウザへの配慮を人間の手で行うのが現実的ではありません。画像が10枚、100枚と増えていくごとに、手動での変換作業は破綻します。更新のたびに複数フォーマットを用意し、適切に配信する仕組みを手動で管理するなど、とても続けられません。
