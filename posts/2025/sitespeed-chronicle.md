...
ただし、CrUXデータへのアクセスにはBigQueryを使う必要があるなど、技術的なハードルの高さが難点でした。

## サイトスピード 振り返り・競合比較なら、URLを入れるだけ
...
![サイトスピード 振り返り・競合比較のレポート例](./sitespeed-chronicle-hero.png)
...
サイトスピード 振り返り・競合比較では、**AIが類似サイトを自動で選定**し、競合との相対比較を行います。自社サイトが業界内でどのような位置にいるのか、一目で把握できます。
...
サイトスピード 振り返り・競合比較は、そのための最初の一歩として最適なツールです。URLを入力するだけで、5年間の推移はもちろん、競合との比較まで、すべて無料で確認できます。
