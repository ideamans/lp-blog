...
もちろん、そうした努力もAIモデルの高度化に貢献しています。しかし、AIを活用する企業も無邪気に「AIを人間に近づける」というAI企業と同じ方向を向いたままでいいのでしょうか。**同じ方向を向いているということは、その先はレッドオーシャンです。**
...
気づいていないかもしれませんが、一歩引いてみると、これは人類共通の使命感に縛られて、みんなが同じ方向にもがいている状況です。 **不気味の谷に囚われた者たちが、こぞってレッドオーシャンへ突き進んでいる** ──そう見えてなりません。
...
不気味の谷を埋めようと差異の解消に打ち込み、コンウェイの法則の引力で結局は今の自分たちを再生産する方向へ収束していく。この **二重の引力** が、多くの企業をAI時代のレッドオーシャンに突き進ませていると思います。
...
当時の自動車製造は、熟練した職人が一台ずつ組み立てていました。当時もおそらく、自動車の可能性にかけて切磋琢磨していた人たちが多くいたはずです。その中では、機械を人間に近づけるための工夫が繰り広げられていたのではないかと想像します。今のAIをめぐる状況に似た構図だと感じています。

ヘンリー・フォードが選んだのは、その逆の道でした。ベルトコンベアという機械の動きに合わせて、人間の側が作業を変え、分業に徹する。分業を徹底することで、熟練工になるまでの長い育成期間を大きく短縮し、誰もが生産プロセスへ参加できる環境が整いました。
...
紙の書類のフォーマットを変えずにデジタル化した。ファイルをクラウドに移した。会議の手順は変えないままオンライン会議ツールを導入した。ツールは変わっても、 **業務の本質は変わらなかった** 。これこそ、DXが幻に終わった多くのケースの典型例です。
...
逆張りは、はじめ愚かな行為に見えるものです。しかし、向かう人の少ない先がブルーオーシャンとは限らない。それでも、**向かう人が多い先は必ずレッドオーシャンになる。** これは確実に言えることです。
